...
{
    public partial class PlaybackItemManagementUIService<T> : PlaybackSequenceServiceBase, IPlaybackItemManagementUIService where T : IMediaPlayerItemSourceProvder
    {
