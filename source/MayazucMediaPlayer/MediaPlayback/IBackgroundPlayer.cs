...
namespace MayazucMediaPlayer.MediaPlayback
{
    public interface IBackgroundPlayer : IDisposable
    {
        ...
        /// <summary>
        /// reset filtering on existing media playback items
        /// </summary>
        ...
        /// <summary>
        /// start timer to stop music at specific time
        /// </summary>
        /// <returns></returns>
        Task HandleStopMusicOnTimer();

        /// <summary>
        /// Clear queue, destory any media source
        /// </summary>
        Task StopPlayback();

        /// <summary>
        /// only to be used while seeking from external sources (like seekbar, jump previous/next)
        /// </summary>
        ...
        /// <summary>
        /// play is state is paused, pause if state is playing.
        /// if force start => Resume from saved position.
        /// </summary>
        ...
        /// <summary>
        /// if there's already a track playing, skip to the next one.
        /// skip to next index if not playing.
        /// </summary>
        /// <returns></returns>
        Task SkipNext();

        /// <summary>
        /// if there's already a track playing, and time is less than 5 seconds, skip previous
        /// if there's already a track playing, and time is bigger than 5 seconds, seek to 0
        /// skip to previous index if not playing.
        /// </summary>
        /// <returns></returns>
        Task SkipPrevious();
        ...
        /// <summary>
        /// reload next track in playback list
        /// </summary>
        /// <returns></returns>
        ...
        /// <summary>
        ///  delay subtitles in current track
        /// </summary>
        /// <returns></returns>
        Task<TimeSpan> DelaySubtitles();

        /// <summary>
        ///  quick subtitles in current track
        /// </summary>
        /// <returns></returns>
        Task<TimeSpan> QuickenSubtitles();

        /// <summary>
        /// if playing, destory source, recreate source, recreate current item, seek to position, play
        /// </summary>
        /// <returns></returns>
        ...
        /// <summary>
        /// Stop the play to reciever, reload the saved playback queue. Do not start playing
        /// </summary>
        /// <returns></returns>
        ...
        /// if current item was removed, start playback from 0, reload next item
        /// if current item was not removed, reload next item
        /// </summary>
        ...
        /// <summary>
        /// 
        /// if playback queue is empty => same as enqueue new list
        /// if playback queue is not empty => Add items to playback queue, reload next item
        /// </summary>
        ...
        /// <summary>
        /// clear old queue, add new items to now playing, recreate source, skip to index, seek to start position, play
        /// </summary>
        ...
        /// <summary>
        /// save new playback queue to disk, reload next time
        /// </summary>
        /// <returns></returns>
