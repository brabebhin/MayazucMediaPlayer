    ...
    public partial class PlaybackSequence : MediaDataStorageUIWrapperCollection<MediaPlayerItemSourceUIWrapper>, IPlaybackSequence
    {
        ...
        public async Task AddToSequenceAsync(IEnumerable<IMediaPlayerItemSource> mediaDatas, int index)
        {
            await Dispatcher.EnqueueAsync(() =>
            {
                ...
                LoadThumbnails(newMembers);
                SaveInstanceToBackstoreInternal();
            });
        }
        ...
        private void LoadThumbnails(IEnumerable<MediaPlayerItemSourceUIWrapper> items)
        {
        ...
        public void SaveInstanceToBackStore()
        {
            SaveInstanceToBackstoreInternal();
        }

        private void SaveInstanceToBackstoreInternal()
        {
